...
//            Route::post('password/forgot', 'ResetPasswordController@forgot')->name('verification.resend');
//            Route::post('password/reset', 'ResetPasswordController@reset')->name('verification.resend');
//
